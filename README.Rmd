...
* **appointments.rda**: A very provisional dataset that will eventually be all ministers etc. Don't use it for anything yet.

![alt text](man/figures/schema.png)

The datasets are up-to-date as of 31 October 2019 (i.e. they include the deaths of Tim Fisher and Elaine Darling, and the appointment of Sarah Henderson).
...
Alexander, Rohan. (2019). Three datasets on Australian politics. Working paper.
